...
#define FLV_TOTAL_HEADER_SIZE		16
...
public:
	...
	u32 GetTotalBytesUsed()
	{
		if(FLV_CHUNK_META == m_enmChunkType)
		{
			return (FLV_TOTAL_HEADER_SIZE + m_dwDataBufferLength - 1);
		}
		else
		{
			return (FLV_TOTAL_HEADER_SIZE + m_dwDataBufferLength);
		}		
	}
